...
export default function ChemistryReportsSection() {
    ...
    const fetchData = async () => {
        try {
            const [resReports, resHorses] = await Promise.all([
                fetch('/api/getReports?mode=chemistry'),
                fetch('/api/horses'),
            ]);
    ...
    return (
        <section className="bg-white shadow rounded-lg p-6 mb-6">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold">Chemistry Reports</h2>
                <Link
                      ...
                      .join('; ')}
                                    ...
                                    <td className="px-4 py-2">
                                        <div className="flex gap-3">
                                            <Link
                                                href={`/dashboard/chemistryreport/${report._id}`}
